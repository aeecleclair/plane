...
```
curl -fsSL -o setup.sh https://github.com/torbenraab/plane/releases/latest/download/setup.sh
...
```
curl -fsSL -o setup.sh https://github.com/torbenraab/plane/releases/latest/download/swarm.sh
